                    ...
                    <div className="md:w-1/2">
                        <Reveal>
                            ...
                            <p className="text-slate-600 mb-4 leading-relaxed">
                                Atualmente cursando Ciência da Computação, sou apaixonado por entender como as coisas
                                funcionam &quot;por baixo dos panos&quot;. Minha jornada começou com curiosidade e se
                                transformou em uma carreira focada em desenvolvimento web moderno.
                            </p>
                            <p className="text-slate-600 mb-6 leading-relaxed">
                                Valorizo código limpo, tipagem estática e arquiteturas escaláveis. Gosto do desafio de
                                pegar problemas complexos e criar sistemas que sejam não só eficientes, mas também
                                elegantes e fáceis de manter.
                            </p>
                            ...
                            <div className="border-l-2 border-slate-200 pl-8 space-y-8 relative">
                                <div className="relative">
                                    ...
                                    <p className="text-slate-500 text-sm mt-2">
                                        ...
                                        modernas como Typescript, Next.js, TailwindCSS, ShadCN, Hono, Prisma e AWS. Além
                                        disso estou aplicando conhecimento teoricos na faculdade como desenhar diagramas
                                        ER do banco de dados e levantamento de requisitos
                                    </p>
                                </div>
                                <div className="relative">
                                    <div className="absolute -left-[41px] top-1 w-5 h-5 rounded-full border-4 border-white bg-primary"></div>
                                    ...
                                    <p className="text-slate-500 text-sm mt-2">
                                        Estudando na Universidade Estadual do Vale do Acaráu. Obtendo o conhecimento
                                        teorico que todo desenvolvedor deve ter.
                                    </p>
                                </div>
                                <div className="relative">
                                    ...
                                    <p className="text-slate-500 text-sm mt-2">
                                        Primeiro contato com lógica de programação e algoritmos, durante a Olimpíada
