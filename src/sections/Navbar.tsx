        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <button
              ...
              className="text-sm font-medium bg-slate-900 text-white hover:bg-primary px-5 py-2 rounded-full transition-colors cursor-pointer"
            >
              Vamos conversar
            </button>
          </div>
        ...
        <div className="md:hidden bg-white border-b border-border px-4 py-4 space-y-4 shadow-lg animate-in slide-in-from-top-5">
          {navLinks.map((link) => (
            <button
              ...
              className="block text-slate-600 hover:text-primary font-medium cursor-pointer"
            >
              {link.name}
            </button>
          ))}
          <button
            ...
            className="block text-primary font-bold cursor-pointer"
          >
            Contato
          </button>
        </div>
