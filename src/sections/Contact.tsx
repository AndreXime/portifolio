            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
                <Reveal>
                    ...
                    <p className="text-slate-600 mb-8 leading-relaxed">
                        Estou sempre aberto a novas oportunidades, projetos freelance ou apenas um bate-papo sobre
                    ...
                    <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-lg flex flex-col">
                        <form className="space-y-4" onSubmit={handleSubmit}>
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full py-3 bg-primary text-white font-bold rounded-lg hover:bg-primaryDark transition-colors shadow-lg shadow-blue-500/25"
                            >
