...
## Destaques
- Home como “shell” com cartões tipados e **ilhas interativas** por app
- Conteúdo + dados em **banco relacional** com migrações transacionais
- Coleções do framework com **validação por esquema** para contrato explícito
- Admin com **cookie seguro** e checagem por operação sensível
