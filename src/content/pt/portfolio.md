...
seo:
  ...
  description: >-
    Portfólio de André Ximenes, desenvolvedor backend TypeScript
    com base fullstack. APIs com NestJS, Hono e Node.js.
...
person:
  ...
  description: >-
    Desenvolvedor backend TypeScript com base fullstack.
    Foco em APIs modulares, contratos tipados e arquitetura sustentável.

hero:
  headline: "Construindo APIs eficientes, seguras e fáceis de manter."
  headlineAccent: "APIs"
  intro: >-
    Sou desenvolvedor de software focado no ecossistema TypeScript,
    com forte inclinação para o desenvolvimento backend. Crio APIs
    modulares e auto-documentadas aplicando boas práticas de arquitetura.
    Atualmente buscando minha próxima oportunidade como desenvolvedor júnior.
